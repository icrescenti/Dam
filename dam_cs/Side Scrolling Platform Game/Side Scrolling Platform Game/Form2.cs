...
namespace Side_Scrolling_Platform_Game
{
    public partial class Form2 : Form
    {
        ...
        private void mainGameTimer(object sender, EventArgs e)
        {
            ...
            if (pictureBox1.Location.X >= 1000 || pictureBox1.Location.X <= 400) bloc_moviment = bloc_moviment*-1;

            pictureBox1.Location = new Point(pictureBox1.Location.X+bloc_moviment, pictureBox1.Location.Y);

            if (door.Location.X > 0 && door.Location.X < this.Width && door.Location.Y > 0 && door.Location.Y < this.Height)
                door.Location = new Point(door.Location.X + r.Next(-30, 30), door.Location.Y + r.Next(-30, 30));
            else
                door.Location = new Point(this.Width/2, this.Height / 2);
